...
export default function ModesBotMessageBubble({ profilePic, name, domain, message }) {
    if (!message || typeof message.text !== 'string') return null;
  return (
    <div className="bot-bubble">
      <img src={profilePic} alt="Bot Profile" className="bot-profile-pic" />
      <div className="bot-message-content">
        <div className="bot-meta"><strong>{domain}</strong>: {name}</div>
